...
def show_contactable():
    ...
    data = {
        "release_date": [
            ...
            "2024-09-11", "2024-03-14", "2023-06-01", "2024-01-25", "2024-10-16"
        ],
        "contactable_authors": [
            ...
            3408217, 2408993, 2528582, 3013784, 3098705, 2463843, 2154091, 2432701, 3276216
        ],
        "non_contactable_authors": [
            ...
            10343548, 7768536, 9457266, 9838423, 9897369, 8385618, 5300196, 7911001, 10177334
        ],
        "total_authors": [
            ...
            12996074, 10849461, 7454287, 10343702, 13453550
        ]
    }
